...
class AtomFeedGenerator {
  ...
  static const String _feedSubtitle =
      'Latest posts from the Cline AI coding assistant blog';
  ...
  String generateAtomFeed(List<BlogPost> posts) {
    ...
    builder.element('feed', nest: () {
      ...
      final latestDate =
          posts.isNotEmpty ? posts.first.publishDate : DateTime.now();
      ...
      // Rights
      builder.element('rights',
          nest: '© 2025 Cline Bot Inc. All rights reserved.');

      // Icon and logo
      builder.element('icon',
          nest: 'https://cline.bot/assets/icons/favicon-32x32.png');
      builder.element('logo',
          nest: 'https://cline.bot/assets/icons/favicon-256x256.png');
  ...
  String _formatHtmlContent(BlogPost post) {
    ...
    final content =
        post.fullContent.isNotEmpty ? post.fullContent : post.excerpt;
